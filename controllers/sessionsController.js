...
export class sessionsController {
    async createSession(req, res) {
        try {
            ...
            const { name, last_name, number_phone, tariff_id, status_visitor } = req.body[1]
            const visitor = await pool.query(`INSERT INTO visitors (session_id, name, lastname, number_phone, tariff_id, status) values ($1, $2, $3, $4, $5, $6) RETURNING *`, [session.rows[0].id, name, last_name, number_phone, tariff_id, status_visitor])
